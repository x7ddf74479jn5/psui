 ...
 *
 * [Radix Docs] @see https://www.radix-ui.com/docs/primitives/components/tabs
 *
 * Content Default Classes: ~ "mt-2 rounded-md border border-line p-6 " ~
 *
 * List Default Classes: ~ "inline-flex items-center justify-center rounded-md bg-base-2 p-1" ~
 *
 * Trigger Default Classes: ~ "inline-flex min-w-[100px] items-center justify-center rounded-[0.185rem] px-3 py-1.5  text-sm font-medium text-base-content-2 transition-all  disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-base data-[state=active]:text-base-content data-[state=active]:shadow-sm" ~
 *
 */
export const Tabs = ({
  className,
